...
import { IconUIComponent as IconUIComponent_23 } from 'components/payload/icon-select'
import { IconSelectComponent as IconSelectComponent_24 } from 'components/payload/icon-select'
...
export const importMap = {
  ...
  "/components/payload/icon-select#IconUIComponent": IconUIComponent_23,
  "/components/payload/icon-select#IconSelectComponent": IconSelectComponent_24
}
